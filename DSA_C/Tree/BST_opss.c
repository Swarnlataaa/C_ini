...
// Function to calculate the space complexity of the binary search tree
int spaceComplexity(struct TreeNode *root)
{
    if (root == NULL)
    {
        return 0;
    ...
    return 1 + spaceComplexity(root->left) + spaceComplexity(root->right);
}
